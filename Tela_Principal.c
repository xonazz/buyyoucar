...
void tela_sobre(void) {
    ...
    printf("| seus processos de gestão, seja implementando, atualizando ou otimizando     |\n");                                                         |\n");                                                |\n");módulos como os de clientes, veículos e funcionários. O objetivo principal é ajudar pequenas e médias empresas a melhorar a eficiência e modernizar seus processos de gestão, seja implementando, atualizando ou otimizando suas operações.                       |\n");                                                         |\n");                                                           |\n");                                                      |\n");
